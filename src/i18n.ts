  ...
  en: {
    translation: {
      ...
      onboarding: {
        ...
        subtitle: 'Pick a professionally designed template. You can always change it later.',
        startBuilding: 'Start Building',
        selectTemplate: 'Select a template to continue',
  ...
  vi: {
    translation: {
      ...
      onboarding: {
        ...
        subtitle: 'Chọn một mẫu được thiết kế chuyên nghiệp. Bạn có thể thay đổi bất cứ lúc nào.',
        startBuilding: 'Bắt đầu xây dựng',
        selectTemplate: 'Chọn một mẫu để tiếp tục',
