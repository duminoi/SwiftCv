...
export const TEMPLATE_META: Record<TemplateType, TemplateMeta> = {
  standard: {
    id: 'standard',
    name: 'The International Standard',
    category: ['ats', 'professional'],
    tags: ['ATS', 'Corporate', 'Clean'],
  ...
  executive: {
    id: 'executive',
    name: 'The Minimalist CEO',
    category: ['minimal', 'professional'],
    tags: ['Executive', 'Serif', 'Elegant'],
  ...
  tech: {
    id: 'tech',
    name: 'The Pixels Code',
    category: ['modern', 'creative'],
    tags: ['Modern', 'Dark', 'Developer'],
  ...
  modern: {
    ...
    category: ['modern', 'ats'],
    tags: ['Modern', '2-Column', 'Professional'],
  ...
  timeline: {
    id: 'timeline',
    name: 'The Timeline Pro',
    category: ['modern', 'professional'],
    tags: ['Timeline', 'Chronological', 'Clean'],
  ...
  professional: {
    id: 'professional',
    name: 'The Corporate Navy',
    category: ['professional', 'ats'],
    tags: ['Corporate', 'Navy', 'Trustworthy'],
  ...
  academic: {
    ...
    category: ['minimal', 'professional'],
    tags: ['Academic', 'Clean', 'Researcher'],
  ...
  bold: {
    ...
    category: ['creative', 'modern'],
    tags: ['Bold', 'Impact', 'High-Contrast'],
  ...
  sidebar: {
    id: 'sidebar',
    name: 'The Sidebar Classic',
    category: ['minimal', 'professional'],
    tags: ['Sidebar', 'Clean', 'Organized'],
  ...
  minimal: {
    id: 'minimal',
    name: 'The Ultra Minimal',
    category: ['minimal', 'ats'],
    tags: ['Minimal', 'Mono', 'Purist'],
